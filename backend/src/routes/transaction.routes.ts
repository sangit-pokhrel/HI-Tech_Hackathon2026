...
export const transactionRoutes = new Elysia({ prefix: "/api/transactions" })
  .post("/", TransactionController.createTransaction, {
    body: t.Object({
      ...
      sender_code: t.String({ minLength: 1 }),
      sender_name: t.String({ minLength: 1 }),
      receiver_code: t.String({ minLength: 1 }),
      receiver_name: t.String({ minLength: 1 }),
  ...
  .get("/", TransactionController.getTransactions, {
    query: t.Object({
      ...
      status: t.Optional(t.String()),
      sender_code: t.Optional(t.String()),
      receiver_code: t.Optional(t.String()),
  ...
  .put("/:id", TransactionController.updateTransaction, {
    ...
    body: t.Object({
      ...
      receiver_code: t.Optional(t.String()),
      receiver_name: t.Optional(t.String()),
